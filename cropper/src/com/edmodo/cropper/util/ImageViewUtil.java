...
public class ImageViewUtil {
    ...
    public static float getYScale(Matrix matrix){
        float[] f = new float[9];
        matrix.getValues(f);
        return f[Matrix.MSCALE_Y];
    }
    public static float getYTran(Matrix matrix){
        float[] f = new float[9];
        matrix.getValues(f);
        return f[Matrix.MTRANS_Y];
    }
    public static float getPers0(Matrix matrix){
        float[] f = new float[9];
        matrix.getValues(f);
        return f[Matrix.MPERSP_0];
    }
    public static float getPers1(Matrix matrix){
        float[] f = new float[9];
        matrix.getValues(f);
        return f[Matrix.MPERSP_1];
    }
    public static float getPers2(Matrix matrix){
        float[] f = new float[9];
        matrix.getValues(f);
